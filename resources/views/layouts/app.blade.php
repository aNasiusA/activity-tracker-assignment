...
<body class="bg-gradient-to-br from-slate-50 via-white to-slate-50 min-h-screen">
    ...
    <main class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        @if (session('success'))
            <div id="toast-success"
                class="mb-6 p-4 pl-5 bg-gradient-to-r from-emerald-50 to-teal-50 border-l-4 border-emerald-500 rounded-lg text-emerald-900 flex items-center gap-3 shadow-sm transition-opacity duration-500">
        ...
        @if (session('error'))
            <div id="toast-error"
                class="mb-6 p-4 pl-5 bg-gradient-to-r from-red-50 to-rose-50 border-l-4 border-red-500 rounded-lg text-red-900 flex items-center gap-3 shadow-sm transition-opacity duration-500">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const toasts = [document.getElementById('toast-success'), document.getElementById('toast-error')];
